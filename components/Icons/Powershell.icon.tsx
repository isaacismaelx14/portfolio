...
const PowershellIcon = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <title>{"file_type_powershell"}</title>
        <path
        ...
        />
        <path
            d="M16.04,21.544h5.086a1.118,1.118,0,0,1,0,2.234H16.04a1.118,1.118,0,0,1,0-2.234Z"
            style={{
                fill: "#2c5591",
                fillRule: "evenodd",
            }}
        ...
        />
        <path
            d="M15.9,21.412h5.086a1.059,1.059,0,1,1,0,2.118H15.9a1.059,1.059,0,1,1,0-2.118Z"
            style={{
                fill: "#fff",
                fillRule: "evenodd",
            }}
